...
const CARD_TYPES = [
  {
    name: "Common",
    desc: "Common cards have a dot/circle in the upper-right corner and a colored background.",
    img: "https://rintaki.org/wp-content/uploads/2026/04/FC260210-218x300.png",
  },
  {
    name: "Rare",
    desc: "Rare cards have a star in the upper-right corner and a scene background.",
    img: "https://rintaki.org/wp-content/uploads/2026/04/FC260118-218x300.png",
  },
  {
    name: "Super Rare",
    desc: "Super Rare cards have a diamond in the upper-right corner, scene background, and a gloss effect.",
    img: "https://rintaki.org/wp-content/uploads/2026/04/FC260230-218x300.png",
  },
  {
    name: "Ultra Rare",
    desc: "Ultra Rare cards have two diamonds in the upper-right corner, a scene background, and a holographic effect.",
    img: "https://rintaki.org/wp-content/uploads/2026/04/FC260134-218x300.png",
  },
  {
    name: "Ultra Rare Special",
    desc: "Ultra Rare Special cards have two diamonds, a scene background, and a glitter-hologram effect.",
    img: "https://rintaki.org/wp-content/uploads/2026/04/FC260140-218x300.png",
  },
];
...
export default function TradingCardGuide() {
  ...
  return (
    <Card className="p-4" data-testid="trading-card-guide">
      <div className="text-[10px] uppercase tracking-widest font-black text-[var(--primary)]">Guide</div>
      <h2 className="font-black text-xl leading-tight">How trading works</h2>
      <p className="text-sm text-[var(--muted-fg)] mt-2">
        ...
        Rare Special have the fewest. We also give away free cards at conventions — sometimes from special editions where you can win more cash for
        collecting the whole set.
      </p>

      <div className="flex gap-2 mt-4">
        <button
          onClick={() => setTab("non-member")}
          data-testid="guide-tab-non-member"
